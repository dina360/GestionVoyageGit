...
%>
        ...
        <h1 class="text-center mb-4">Découvrez nos offres de voyage</h1>
                            ...
                            <div class="card position-relative">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="price-section">
                                        ...
                                        <h6><s><%= prix_initiale %></s>&nbsp;&nbsp;<%= prix_actuel %></h6><br>
                                    </div>
                                    ...
                                    <div class="price-transport">
                                        <img class="icon" src="./css/icones/pack_dis.png" width="10px" height="10px">&nbsp;<br><h6>Nombre de paquets restants est  <%= nbr%></h6>
                                    </div>
