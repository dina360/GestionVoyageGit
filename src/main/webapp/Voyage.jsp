...
<div class="container custom-form"  >
           ...
           <div class="col-md-6">
             <div class="form-group">
                ...
                <form action="AddPackageServlet" method="post" enctype="multipart/form-data" >
                    ...
                    <!-- Modifier les champs de remise et de nombre de pack dans le formulaire -->
					<div class="form-group">
					    <label for="remise">Pourcentage de remise</label>
					    <!-- Définir la valeur par défaut à 0 -->
					    <input type="number" class="form-control" id="remise" name="remise" value="0" disabled onfocus="checkSelection()">
					</div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
					    <label for="nbr">Nombre Du Paquet Disponible</label>
					    <!-- Définir la valeur par défaut à 255 -->
					    <input type="number" class="form-control" id="nbr" name="nbr" value="255" disabled onfocus="checkSelection()">
					</div>
    ...
    function handleSelectionChange() {
        ...
        if (selection) {
            ...
            if (selection === 'offre') {
                window.location.href = 'GestionOffre.jsp';
            }
        } else {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // Initialise le champ du prix actuel avec la même valeur que le prix initial
        const prixInitialField = document.getElementById('p_i');
        const prixActuelField = document.getElementById('p_a');
        prixActuelField.value = prixInitialField.value;

        // Écoute les événements de saisie sur le champ du prix initial pour mettre à jour le champ du prix actuel
        prixInitialField.addEventListener('input', () => {
            prixActuelField.value = prixInitialField.value;
        });
    });
